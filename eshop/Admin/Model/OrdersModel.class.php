	...
	class OrdersModel extends Model{
		...
		*/
		...
		public function detail($id){
			...
			$detailList = $this->field('goods.goods_name goods_name,detail.goods_attr_id attr_value,detail.price price,detail.num num')->join('LEFT JOIN detail ON orders.id = detail.orders_id')->join('LEFT JOIN goods ON detail.goods_id = goods.id')->where("orders.id = {$id}")->select();
			return $detailList;
		}
